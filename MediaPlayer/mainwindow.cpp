    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->settingsBtn, &QToolButton::clicked, this, &MainWindow::settingBtn);
    connect(ui->actionEdit, &QAction::triggered, this, &MainWindow::settingBtn);
...
void MainWindow::on_actionPlayAndPause_triggered()
{
...
void MainWindow::on_actionAbout_MediaPlayer_triggered()
{
...
void MainWindow::on_removeVideo_clicked()
{
